//-----------------------------------------------------------------------
// <copyright file="IMSHealthClient.Async.cs" company="Jorge Alberto Hernández Quirino">
...
namespace MSHealthAPI.Contracts
{
    ...
    public partial interface IMSHealthClient
    {
        ...
        Task<MSHealthRedirectResult> HandleRedirectAsync(Uri uri);
        ...
        Task<MSHealthActivities> ListActivitiesAsync(DateTime? startTime = default(DateTime?),
        ...
        /// <returns></returns>
        Task<MSHealthSummaries> ListDailySummariesAsync(DateTime? startTime = default(DateTime?),
                                                        DateTime? endTime = default(DateTime?),
                                                        string deviceIds = null,
                                                        int? maxPageSize = default(int?));
        ...
        /// <param name="maxPageSize">The maximum number of entries to return per page. Defaults to 48 for hourly and 31 for daily.</param>
        /// <returns></returns>
        Task<MSHealthSummaries> ListHourlySummariesAsync(DateTime? startTime = default(DateTime?),
                                                         DateTime? endTime = default(DateTime?),
                                                         string deviceIds = null,
                                                         int? maxPageSize = default(int?));
        ...
        Task<MSHealthDevices> ListDevicesAsync();
        ...
        Task<MSHealthActivity> ReadActivityAsync(string id, MSHealthActivityInclude include = MSHealthActivityInclude.None);
        ...
        Task<MSHealthDevice> ReadDeviceAsync(string id);
        ...
        Task<MSHealthProfile> ReadProfileAsync();
		...
		/// it's necessary to set use <see cref="MSHealthScope.OfflineAccess"/>.
		/// </remarks>
		Task<bool> ValidateTokenAsync(MSHealthToken token, bool refreshIfInvalid = true);
